      ...
      <div className="contact__wrapper container">
        <div className="contact__info">
          ...
          <div className="info__span">
            ...
            <span>
              <h5>Contact me </h5>
              <a target="_blank" href="https://t.me/developer_SN">channel: developer_SN</a>{" "}
              <br />
              <a target="_blank" href="tel:+998907732709">90-773-27-09</a>
            </span>
          </div>
          <div className="info__span">
            <p>
          ...
          <div className="info__span__last">
            ...
            <span>
              ...
              <p>
                <a target="_blank" href="https://www.instagram.com/dasturchi__qiz/">
